...
export const BuyerDashboardPage: React.FC = () => {
  ...
  return <div className={styles.dashboard}>
    <header className={styles.header}><div><h1 className="text-[#14532D]">Good morning, {firstName} 👋</h1><p>Here's what needs your attention today.</p><span className={styles.location}><MapPin size={16} />{location}</span></div><div className={styles.quickActions}><Badge variant="info" className={styles.quickAction}><Globe2 size={16} />English</Badge><Badge variant="info" className={styles.quickAction}><Mic size={16} />Voice Assistant</Badge><button className={styles.profileButton} aria-label="Profile"><UserCircle size={20} /></button></div></header>
