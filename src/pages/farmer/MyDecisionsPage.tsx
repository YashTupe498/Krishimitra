...
export const MyDecisionsPage: React.FC = () => {
  ...
  return <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
    <header className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
      ...
      <div className="relative z-10"><div className="flex items-center gap-3 mb-2"><div className="w-10 h-10 rounded-xl bg-green-100 text-green-700 flex items-center justify-center"><Lightbulb size={20} /></div><h1 className="text-2xl md:text-3xl font-display font-bold text-gray-900">MY DECISIONS</h1></div><p className="text-gray-600">Understand what to do with your produce.</p></div>
