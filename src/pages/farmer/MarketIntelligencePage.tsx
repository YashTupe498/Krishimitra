          ...
          <div className="flex-1 min-h-[200px] mt-2">
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={priceHistory} margin={{ top: 10, right: 10, bottom: 10, left: -10 }}>
                ...
                <Tooltip contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 8px 24px rgba(0,0,0,0.12)' }} formatter={(v: any) => [`₹${v}`, 'modal_price']} labelFormatter={(label: React.ReactNode) => label ?? ''} />
