    ...
    <div className={clsx(styles.layout, 'farmer-theme')}>
      <aside className={styles.sidebar}>
        ...
        <div className={styles.secondaryNav}>
          ...
          <NavLink to="/buyer/profile" className={clsx(styles.navItem, location.pathname === '/buyer/profile' && styles.active)}><UserCircle size={20} className={styles.navIcon} /><span>Profile</span></NavLink>
          <button className={clsx(styles.navItem, styles.logout)} onClick={handleLogout}><LogOut size={20} className={styles.navIcon} /><span>Logout</span></button>
        </div>
      </aside>
